---
title: "Run {verdepcheck} strategies from a docker container"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Run {verdepcheck} from a docker container}
...
renv::install("insightsengineering/verdepcheck@fix-random-download%40main", prompt = FALSE)

# Parameters -------------------------------------------------------------------

github_id <- "insightsengineering/teal.modules.clinical"
ref <- "--branch 546-fix-verdepcheck@main" # branch, tag or NULL
depth <- "--depth 1" # or NULL
build_args <- " " # When empty it should have 1 space
r_cmd_check_args <- " " # When empty it should have 1 space
strategy <- "min_isolated"
