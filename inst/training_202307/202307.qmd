...
Therefore only **direct** dependencies are being looked into.
...
Dependency resolution will _collapse_ the whole dependency tree and warn about conflicts.
...
- This does not perform matrix testing of _all_ dependent package versions.
